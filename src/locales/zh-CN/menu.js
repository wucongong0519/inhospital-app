export default {
  ...
  'menu.users': '用户管理',
  'menu.users.user': '用户管理',
  'menu.users.group': '群组管理',
  'menu.users.roles': '角色管理',
  'menu.hospital': '医院管理',
  'menu.hospital.regions': '院区列表',
  'menu.hospital.services': '服务列表',
  'menu.hospital.deparment': '科室列表',
  'menu.hospital.areas': '病区列表',
  'menu.hospital.information': '医院参数',
  'menu.stock': '库房管理',
  'menu.stock.suppliers': '供应商列表',
  'menu.stock.stocks': '库房列表',
  'menu.stock.product': 'FSMP列表',
};
